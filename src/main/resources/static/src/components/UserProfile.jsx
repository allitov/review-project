        ...
        <>
          ...
          <div className="tabs-container">
            <nav className="tabs-nav">
              {['Profile', 'My Articles', 'Submit Article'].map(tab => (
                <button
                  key={tab}
                ...
                >
                  {tab === 'Profile' && 'Профиль'}
                  {tab === 'My Articles' && 'Мои статьи'}
                  {tab === 'Submit Article' && 'Опубликовать статью'}
                </button>
              ))}
            </nav>
          </div>
          ...
          {activeTab === 'My Articles' && (
            <div className="tab-content-placeholder">
              Содержимое для "Мои статьи" будет здесь.
            </div>
          )}
          {activeTab === 'Submit Article' && (
            <div className="tab-content-placeholder">
              Форма для публикации статьи будет здесь.
            </div>
          )}
        </>
      )}
